class Solution:
    def topKFrequent(self, nums: List[int], k: int) -> List[int]:
        ...
        # TC: O(n log k) where n is the number of elements and k is the size of the elements in the heap
            # in this case, k would be the input k at all times
        # SC: O(n + k)
            # n is the space used for the map and k is the space for the heap
